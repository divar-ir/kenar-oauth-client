...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(os.path.dirname(SETTINGS_DIR), '/handler/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get("DB_NAME", "oauth"),
        'USER': os.environ.get("DB_USER", "oauth"),
        'PASSWORD': os.environ.get("DB_PASSWORD", "oauth"),
